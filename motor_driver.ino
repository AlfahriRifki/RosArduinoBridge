...
#elif defined(ORIENTAL_MOTOR_DRIVER) || defined(ORIENTAL_MOTOR_DRIVER_PC)
  void setMotorSpeed(int i, int spd) {
    unsigned char reverse = 0;
    ...
    if (i == LEFT) { 
      ...
      else if (reverse == 1) { digitalWrite(BRAKE_MOTOR_RIGHT, LOW); digitalWrite(DIRECTION_MOTOR_RIGHT, HIGH); analogWrite(PWM_MOTOR_RIGHT, spd); }
    }
  }
